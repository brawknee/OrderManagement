...
$_SESSION['registration_id'] = "$admin_id";
?>
<!-- case studies -->
	<section class="case_w3ls  py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">Admin Dashboard</h4>
			</div>
			<!-- case studies row -->
			<div class="row">
...
?>
            <p style='color: #01cd74; font-size: 30px; text-align: center'>Login Successful! <br>Welcome <?php echo strtoupper($_SESSION['username']); ?></p>
