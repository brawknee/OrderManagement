...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Jul 18, 2021 at 04:10 PM
...
DROP TABLE IF EXISTS `activity_log_tbl`;
CREATE TABLE IF NOT EXISTS `activity_log_tbl` (
...
(13, 20, 26, 19, 355, 'Toyota Matrix 2004 Silver', 'Few months used tokunbo standard irresponsible as clean as seen inspect! pay! start and go!', 1500000, 1, 19, '2021-01-30 14:21:58'),
...
(21, 'Fatima Murtala', 'fatima@gmaill.com', 'Kaduna', '08078787878', 'maryam.jpg', 'fatima', '2021-01-30 13:37:00'),
...
(31, 20, 'Vehicle Parts & Accessories'),
(30, 20, 'Trucks & Trailers'),
(29, 20, 'Motorcycle & Scooters'),
(28, 20, 'Heavy Equipment'),
(27, 20, 'Buses & MicroBuses'),
(26, 20, 'Cars'),
...
DROP TABLE IF EXISTS `sublocation_tbl`;
CREATE TABLE IF NOT EXISTS `sublocation_tbl` (
...
DROP TABLE IF EXISTS `tracker_status`;
