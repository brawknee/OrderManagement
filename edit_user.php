...
<?php					
	if(isset($_POST['submit'])){
		...
		if (isset($error)) {
			header('Location: edit_user.php?e='.urlencode($error)); exit;
		}
   
        $query=mysqli_query($connection, "UPDATE user_tbl SET fullname='$fullname', phone='$phone', email='$email', username='$username', password='$password' WHERE id='$id'") or die (mysqli_error($connection));
		
		if($query){
            header('Location: view_user.php?s='.urlencode("<b>User Successfully Updated.</b>")); 		
            exit;
		}
}
?>	       
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="" name="phone" required=""  value="<?php echo $c; ?>">
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="your username" name="username" required=""  value="<?php echo $e; ?>">
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-form-label"><b>Password</b></label>
                                <input type="password" class="form-control" placeholder="your password" name="password" id="password" required=""  value="<?php echo $f; ?>">
                            </div>
                            <div class="form-group">
