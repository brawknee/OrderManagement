...
$category_id = base64_decode($_GET['bs']);
$subcategory_id = base64_decode($_GET['as']);
?>
<!-- case studies -->
...
<?php
    ...
    while($row=mysqli_fetch_array($sql)){
		...
		echo "
		<a style='color: #000' href='view_ads_full.php?as=$product_id'>
        ...
        <table class='table borderless' style='font-size:12'>
            <thead>
                <tr style='border: none;'>";
					if(isset($pic)){
                    	echo "<th rowspan='3' style='border: none;'><img src='user_products/$registration_id/$pic' alt='Ads Picture' width='250' height='250' /></th>";
					}else{
						echo "<th rowspan='3' style='border: none;'>No Product <br>Picture Uploaded</th>";
					}	
					echo "
					<th style='border: none; color: #666'><h3>$title </h3></th>
					<th style='color: green; border: none;'><h3>&#8358;".number_format($price,2)."</h3></th>	
