	...
	<section class="case_w3ls  py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">List Of Product Categories</h4>
			</div>
			<!-- case studies row -->
			<div class="row">
        ...
        while($row=mysqli_fetch_array($sql)){
                ...
                echo "<tbody>
                            <tr style='font-size:10'>
                                  ...
                                  ";
                                ?>    
                                    <td><?php echo "<a href=\"delete_category.php?as=$first\">Delete</a>"; ?></td>
                                    <td><?php echo "<a href=\"edit_category.php?as=$first&bs=$second\">Edit</a>"; ?></td>
                           <?php echo "
