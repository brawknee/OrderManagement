	...
	<section class="case_w3ls  py-lg-5">
		<div class="container py-5">
			<div class="text-center wthree-title pb-sm-5 pb-3">
				<h3 class="w3l-sub">Delete Category</h4>
			</div>
			<!-- case studies row -->
			<div class="row">
...
?>
<?php
echo "Are you sure you want to delete this category record? 
...
if(!empty($num)){
  ...
  if($query){
    header('Location: view_category.php?s='.urlencode("<b>Category Record Successfully Deleted</b>")); 		
    exit;									        
  }
}else{
